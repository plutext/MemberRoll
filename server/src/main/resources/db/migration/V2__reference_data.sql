...
-- period, at the published 2025/26 prices (Single $45, Household $65).
-- PLACEHOLDERS flagged in CR-001: confirm the current year's prices and
-- the exact period boundary / renewal-open / late-joining dates with the
-- society before go-live. Another society self-hosting edits these rows
-- (or ships its own V2).
...
VALUES ('2026-2027', DATE '2026-07-01', DATE '2027-06-30', DATE '2026-06-01', DATE '2027-04-01');
