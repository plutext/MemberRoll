...
# THE INSTANCE in /opt/myapp after push-war.sh has synced the deploy
...
# a verbatim copy of server/keycloak/myapp-realm.json): the web client's
...
json.dump(realm, open("keycloak-import/myapp-realm.json", "w"), indent=2)
EOF
